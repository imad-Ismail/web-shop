...
<body>
	...
	<div class="formDiv">
		...
		<div>
		<form action="signinForm.php" method="get"> 
		<h1>Inschrijven</h1>
			<div class="input">
		<input type="text" name="name" autofocus placeholder="Naam">
		<br>
		<input type="text" name="achtername" autofocus placeholder="Achternaam">
		<br>
		...
		<br>
		<input type="password" name="hpassword" placeholder="Herhaling password">
		<br>
